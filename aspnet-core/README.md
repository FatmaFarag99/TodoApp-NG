...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 7fe4a570-0b6d-4964-bc2c-b2d151998249
```

> `7fe4a570-0b6d-4964-bc2c-b2d151998249` is the password of the certificate, you can change it to any password you want.
